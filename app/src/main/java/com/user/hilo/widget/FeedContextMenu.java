...
public class FeedContextMenu extends LinearLayout {
    ...
    public void setOnFeedContextMenuClickListener(OnFeedContextMenuClickListener onFeedContextMenuClickListener) {
        this.onFeedContextMenuClickListener = onFeedContextMenuClickListener;
    }

    @OnClick({R.id.btnReport, R.id.btnSharePhoto, R.id.btnShareUrl, R.id.btnCancel})
